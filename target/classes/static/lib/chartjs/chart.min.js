...
!function t(e, i, n) {
    ...
    1: [function (t, e, i) {
        ...
        function a(t) {
            if (t) {
                var e = /^hsla?\(\s*([+-]?\d+)(?:deg)?\s*,\s*([+-]?[\d\.]+)%\s*,\s*([+-]?[\d\.]+)%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)/,
                    i = t.match(e);
                if (i) {
                    var n = parseFloat(i[4]), a = v(parseInt(i[1]), 0, 360), o = v(parseFloat(i[2]), 0, 100),
                        r = v(parseFloat(i[3]), 0, 100), s = v(isNaN(n) ? 1 : n, 0, 1);
                    return [a, o, r, s]
                }
            }
        }
        ...
        function n(t) {
            var e, i, n, a = t[0] / 255, o = t[1] / 255, r = t[2] / 255, s = Math.min(a, o, r), l = Math.max(a, o, r),
                h = l - s;
        ...
        function o(t) {
            var e = t[0], i = t[1], a = t[2], o = n(t)[0], r = 1 / 255 * Math.min(e, Math.min(i, a)),
        ...
        function h(t) {
            ...
            var a = .4124 * e + .3576 * i + .1805 * n, o = .2126 * e + .7152 * i + .0722 * n,
        ...
        function y(t) {
            var e = t[0] / 60, i = t[1] / 100, n = t[2] / 100, a = Math.floor(e) % 6, o = e - Math.floor(e),
                r = 255 * n * (1 - i), s = 255 * n * (1 - i * o), l = 255 * n * (1 - i * (1 - o)), n = 255 * n;
            switch (a) {
                case 0:
                    return [n, l, r];
                case 1:
        ...
        !function (t, n) {
            ...
            function Nt(t) {
                var e = z(t), i = e.year || 0, n = e.quarter || 0, a = e.month || 0, o = e.week || 0, r = e.day || 0,
                    s = e.hour || 0, l = e.minute || 0, h = e.second || 0, d = e.millisecond || 0;
            ...
            function jt(t, e) {
                var i = (e || "").match(t) || [], n = i[i.length - 1] || [], a = (n + "").match(ua) || ["-", 0, 0],
                    o = +(60 * a[1]) + y(a[2]);
                return "+" === a[0] ? o : -o
            }
            ...
            function ce(t, e) {
                var i = t || Bt(), n = Gt(i, this).startOf("day"), a = this.diff(n, "days", !0),
            ...
            function an(t, e, i) {
                var n = oe(t).abs(), a = io(n.as("s")), o = io(n.as("m")), r = io(n.as("h")), s = io(n.as("d")),
                    l = io(n.as("M")), h = io(n.as("y")),
            ...
            var gn, mn, pn = {}, bn = {},
                ...
                yn = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, xn = {}, kn = {}, _n = /\d/, Sn = /\d\d/,
                wn = /\d{3}/, Mn = /\d{4}/, Cn = /[+-]?\d{6}/, Dn = /\d\d?/, Tn = /\d\d\d\d?/, Pn = /\d\d\d\d\d\d?/,
                An = /\d{1,3}/, Fn = /\d{1,4}/, In = /[+-]?\d{1,6}/, On = /\d+/, Rn = /[+-]?\d+/,
                Wn = /Z|[+-]\d\d:?\d\d/gi, Vn = /Z|[+-]\d\d(?::?\d\d)?/gi, Ln = /[+-]?\d+(\.\d{1,3})?/,
                Bn = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,
                zn = {}, Yn = {}, Hn = 0, Nn = 1, En = 2, Un = 3, jn = 4, Gn = 5, qn = 6, Zn = 7, Jn = 8;
            ...
            var Xn = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
                ...
                $n = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), Kn = Bn, ta = Bn,
            ...
            var ya = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
                xa = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), ka = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), _a = Bn, Sa = Bn,
                wa = Bn;
            ...
            var Ya = Math.abs, Ha = $i("ms"), Na = $i("s"), Ea = $i("m"), Ua = $i("h"), ja = $i("d"), Ga = $i("w"),
                qa = $i("M"), Za = $i("y"), Ja = tn("milliseconds"), Xa = tn("seconds"), Qa = tn("minutes"),
                $a = tn("hours"), Ka = tn("days"), to = tn("months"), eo = tn("years"), io = Math.round,
                no = {s: 45, m: 45, h: 22, d: 26, M: 11}, ao = Math.abs, oo = Nt.prototype;
        ...
        e.exports = function (t) {
            ...
            t.defaults.bar = {
                ...
                updateElement: function (t, i, n) {
                    var a = this.getMeta(), o = this.getScaleForId(a.xAxisID), r = this.getScaleForId(a.yAxisID),
                ...
                calculateBarX: function (t, e) {
                    var i = this.getMeta(), n = this.getScaleForId(i.xAxisID), a = this.getBarIndex(e),
                        o = this.getRuler(t), r = n.getPixelForValue(null, t, e, this.chart.isCombo);
                ...
                updateElement: function (t, i, n, a) {
                    var o = this.getMeta(), r = this.getScaleForId(o.xAxisID), s = this.getScaleForId(o.yAxisID),
                    ...
                    e.extend(t, {
                        ...
                        draw: function () {
                            ...
                            var e = this._chart.ctx, i = this._view, n = i.height / 2, a = i.y - n, o = i.y + n,
                            ...
                            var l = [[i.base, o], [i.base, a], [r, a], [r, o]], h = ["bottom", "left", "top", "right"],
                    ...
                    var i = this.getMeta(), n = this.getScaleForId(i.yAxisID), a = this.getBarIndex(e),
                        o = this.getRuler(t), r = n.getPixelForValue(null, t, e, this.chart.isCombo);
        ...
        e.exports = function (t) {
            ...
            i.doughnut = {
                    ...
                    labels: {
                        generateLabels: function (t) {
                            ...
                            return i.labels.length && i.datasets.length ? i.labels.map(function (n, a) {
                                var o = t.getDatasetMeta(0), r = i.datasets[0], s = o.data[a], l = s.custom || {},
                ...
                update: function (t) {
                    var i = this, n = i.chart, a = n.chartArea, o = n.options, r = o.elements.arc,
                        s = a.right - a.left - r.borderWidth, l = a.bottom - a.top - r.borderWidth, h = Math.min(s, l),
                        d = {x: 0, y: 0}, u = i.getMeta(), c = o.cutoutPercentage, f = o.circumference;
                    if (f < 2 * Math.PI) {
                        var g = o.rotation % (2 * Math.PI);
                        g += 2 * Math.PI * (g >= Math.PI ? -1 : g < -Math.PI ? 1 : 0);
                        var m = g + f, p = {x: Math.cos(g), y: Math.sin(g)}, b = {x: Math.cos(m), y: Math.sin(m)},
                ...
                updateElement: function (t, i, n) {
                    var a = this, o = a.chart, r = o.chartArea, s = o.options, l = s.animation, h = s.elements.arc,
                        d = (r.left + r.right) / 2, u = (r.top + r.bottom) / 2, c = s.rotation, f = s.rotation,
                        g = a.getDataset(),
                        m = n && l.animateRotate ? 0 : t.hidden ? 0 : a.calculateCircumference(g.data[i]) * (s.circumference / (2 * Math.PI)),
                        p = n && l.animateScale ? 0 : a.innerRadius, b = n && l.animateScale ? 0 : a.outerRadius,
        ...
        e.exports = function (t) {
            ...
            t.defaults.line = {
                ...
                update: function (t) {
                    var i, n, a, o, r = this, s = r.getMeta(), l = s.dataset, h = s.data || [], d = r.chart.options,
                        u = d.elements.line, c = r.getScaleForId(s.yAxisID);
                ...
                updateElement: function (t, i, n) {
                    var a, o, r = this, s = r.getMeta(), l = t.custom || {}, h = r.getDataset(), d = r.index,
                        u = h.data[i], c = r.getScaleForId(s.yAxisID), f = r.getScaleForId(s.xAxisID),
                ...
                removeHoverStyle: function (t) {
                    var i = this, n = i.chart.data.datasets[t._datasetIndex], a = t._index, o = t.custom || {},
                        r = t._model;
        ...
        e.exports = function (t) {
            ...
            t.defaults.polarArea = {
                ...
                linkScales: e.noop,
                update: function (t) {
                    var i = this, n = i.chart, a = n.chartArea, o = this.getMeta(), r = n.options, s = r.elements.arc,
                ...
                updateElement: function (t, i, n) {
                    ...
                    var k = t.hidden ? 0 : c.getDistanceFromCenterForValue(s.data[i]), _ = -.5 * Math.PI + m * v,
                        S = _ + (t.hidden ? 0 : m), w = {
                            x: p,
                            y: b,
                            innerRadius: 0,
        ...
        e.exports = function (t) {
            ...
            t.defaults.radar = {
                ...
                update: function (t) {
                    var i = this.getMeta(), n = i.dataset, a = i.data, o = n.custom || {}, r = this.getDataset(),
                ...
                updateElement: function (t, i, n) {
                    var a = t.custom || {}, o = this.getDataset(), r = this.chart.scale,
                        s = this.chart.options.elements.point, l = r.getPointPositionForValue(i, o.data[i]);
                    e.extend(t, {
                        _datasetIndex: this.index,
                        _index: i,
                        _scale: r,
        ...
        e.exports = function (t) {
            ...
            t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function (i) {
                ...
                initialize: function () {
                    ...
                    var i = this.chart.canvas, n = e.getMaximumWidth(this.chart.canvas),
                    ...
                    n.scales && (o = o.concat((n.scales.xAxes || []).map(function (t) {
                        ...
                        var r = n.options, s = e.getValueOrDefault(r.type, n.dtype),
            ...
            t.DatasetController = function (t, e) {
                ...
                setHoverStyle: function (t) {
                    var i = this.chart.data.datasets[t._datasetIndex], n = t._index, a = t.custom || {},
                        o = e.getValueAtIndexOrDefault, r = (e.color, e.getHoverColor), s = t._model;
        ...
        e.exports = function (t) {
            ...
            function a(t, n, a) {
                var o = document.defaultView, r = t.parentNode, s = o.getComputedStyle(t)[n],
                    l = o.getComputedStyle(r)[n], h = i(s), d = i(l), u = Number.POSITIVE_INFINITY;
            ...
            o.each = function (t, e, i, n) {
                ...
                var a = t.skip ? e : t, o = e, r = i.skip ? e : i,
                    ...
                    l = Math.sqrt(Math.pow(r.x - o.x, 2) + Math.pow(r.y - o.y, 2)), h = s / (s + l), d = l / (s + l);
            ...
            o.requestAnimFrame = function () {
                ...
                var i, n, a = t.originalEvent || t, r = t.currentTarget || t.srcElement, s = r.getBoundingClientRect(),
                    l = a.touches;
                l && l.length > 0 ? (i = l[0].clientX, n = l[0].clientY) : (i = a.clientX, n = a.clientY);
                var h = parseFloat(o.getStyle(r, "padding-left")), d = parseFloat(o.getStyle(r, "padding-top")),
                    u = parseFloat(o.getStyle(r, "padding-right")), c = parseFloat(o.getStyle(r, "padding-bottom")),
                    f = s.right - s.left - h - u, g = s.bottom - s.top - d - c;
            ...
            t.layoutService = {
                defaults: {}, addBox: function (t, e) {
                    ...
                    if (t) {
                        ...
                        var m = i - 2 * l, p = n - 2 * h, b = m / 2, v = p / 2, y = (i - b) / (d.length + u.length),
                            x = (n - v) / (c.length + f.length), k = m, _ = p, S = [];
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.legend = {
                ...
                initialize: function (t) {
                    ...
                    var i = this.options, n = i.labels, a = i.display, o = this.ctx, r = t.defaults.global,
                        s = e.getValueOrDefault, l = s(n.fontSize, r.defaultFontSize),
                        h = s(n.fontStyle, r.defaultFontStyle), d = s(n.fontFamily, r.defaultFontFamily),
                        u = e.fontString(l, h, d), c = this.legendHitBoxes = [], f = this.minSize,
                        g = this.isHorizontal();
                    ...
                    var i = this.options, n = i.labels, a = t.defaults.global, o = a.elements.line, r = this.width,
                        s = this.lineWidths;
                    if (i.display) {
                        var l = this.ctx, h = {x: this.left + (r - s[0]) / 2, y: this.top + n.padding, line: 0},
                            d = e.getValueOrDefault, u = d(n.fontColor, a.defaultFontColor),
                            c = d(n.fontSize, a.defaultFontSize), f = d(n.fontStyle, a.defaultFontStyle),
                            g = d(n.fontFamily, a.defaultFontFamily), m = e.fontString(c, f, g);
        ...
        e.exports = function (t) {
            ...
            t.defaults.scale = {
                ...
                calculateTickRotation: function () {
                    var i = this.ctx, n = t.defaults.global, a = this.options.ticks,
                        o = e.getValueOrDefault(a.fontSize, n.defaultFontSize),
                        r = e.getValueOrDefault(a.fontStyle, n.defaultFontStyle),
                        s = e.getValueOrDefault(a.fontFamily, n.defaultFontFamily), l = e.fontString(o, r, s);
                    i.font = l;
                ...
                fit: function () {
                    var i = this.minSize = {width: 0, height: 0}, n = this.options, a = t.defaults.global, o = n.ticks,
                        r = n.scaleLabel, s = n.display, l = this.isHorizontal(),
                        h = e.getValueOrDefault(o.fontSize, a.defaultFontSize),
                        d = e.getValueOrDefault(o.fontStyle, a.defaultFontStyle),
                        u = e.getValueOrDefault(o.fontFamily, a.defaultFontFamily), c = e.fontString(h, d, u),
                ...
                draw: function (i) {
                    var n = this.options;
                    if (n.display) {
                        var a, o, r, s, l, h = this.ctx, d = t.defaults.global, u = n.ticks, c = n.gridLines,
                            f = n.scaleLabel, g = 0 !== this.labelRotation, m = u.autoSkip;
                        ...
                        var p = e.getValueOrDefault(u.fontColor, d.defaultFontColor),
                            ...
                            y = e.getValueOrDefault(u.fontFamily, d.defaultFontFamily), x = e.fontString(b, v, y),
                            k = c.tickMarkLength, _ = e.getValueOrDefault(f.fontColor, d.defaultFontColor),
                            S = e.getValueOrDefault(f.fontSize, d.defaultFontSize),
                            w = e.getValueOrDefault(f.fontStyle, d.defaultFontStyle),
                            M = e.getValueOrDefault(f.fontFamily, d.defaultFontFamily), C = e.fontString(S, w, M),
                            D = e.toRadians(this.labelRotation), T = Math.cos(D),
                        ...
                        if (c.drawBorder) {
                            ...
                            var W = this.left, V = this.right, L = this.top, B = this.bottom,
        ...
        e.exports = function (t) {
            ...
            t.Title = t.Element.extend({
                ...
                beforeFit: i,
                fit: function () {
                    var i = this, n = (i.ctx, e.getValueOrDefault), a = i.options, o = t.defaults.global, r = a.display,
                        s = n(a.fontSize, o.defaultFontSize), l = i.minSize;
                ...
                draw: function () {
                    ...
                    if (o.display) {
                        var s, l, h = a(o.fontSize, r.defaultFontSize), d = a(o.fontStyle, r.defaultFontStyle),
                            u = a(o.fontFamily, r.defaultFontFamily), c = e.fontString(h, d, u), f = 0, g = i.top,
                            m = i.left, p = i.bottom, b = i.right;
            ...
            t.defaults.global.tooltips = {
                ...
                initialize: function () {
                    ...
                    var t = this._options.tooltips.callbacks.beforeTitle.apply(this, arguments),
                        ...
                        n = this._options.tooltips.callbacks.afterTitle.apply(this, arguments), a = [];
                    ...
                    var t = this._options.tooltips.callbacks.beforeFooter.apply(this, arguments),
                        ...
                        n = this._options.tooltips.callbacks.afterFooter.apply(this, arguments), a = [];
                    return a = e(a, t), a = e(a, i), a = e(a, n)
                    ...
                    var e = this._chart.ctx, n = {height: 2 * t.yPadding, width: 0},
                    ...
                    if (0 !== e.opacity) {
                        var n = e.caretPadding, a = this.getTooltipSize(e), o = {x: e.x, y: e.y},
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.elements.line = {
                ...
                lineToNextPoint: function (t, e, i, n, a) {
                    ...
                    var n = this, a = this._view, o = this._chart.ctx, r = this._children[0],
        ...
        e.exports = function (t) {
            ...
            i.elements.point = {
                ...
                inRange: function (t, e) {
                    ...
                    var t, a, o, r, s, l, h = this._view, d = this._chart.ctx, u = h.pointStyle, c = h.radius, f = h.x,
                        g = h.y;
                    if (!h.skip) {
        ...
        e.exports = function (t) {
            ...
            e.elements.rectangle = {
                ...
                draw: function () {
                    ...
                    var e = this._chart.ctx, i = this._view, n = i.width / 2, a = i.x - n, o = i.x + n,
                        r = i.base - (i.base - i.y), s = i.borderWidth / 2;
                    i.borderWidth && (a += s, o -= s, r += s), e.beginPath(), e.fillStyle = i.backgroundColor, e.strokeStyle = i.borderColor, e.lineWidth = i.borderWidth;
                    var l = [[a, i.base], [a, r], [o, r], [o, i.base]], h = ["bottom", "left", "top", "right"],
                        d = h.indexOf(i.borderSkipped, 0);
                    -1 === d && (d = 0), e.moveTo.apply(e, t(0));
                    for (var u = 1; 4 > u; u++) e.lineTo.apply(e, t(u));
                    e.fill(), i.borderWidth && e.stroke()
        ...
        e.exports = function (t) {
            var e = t.helpers, i = {position: "bottom"}, n = t.Scale.extend({
                determineDataLimits: function () {
                    ...
                    if (this.isHorizontal()) {
                        var o = this.width - (this.paddingLeft + this.paddingRight), r = o / a,
                            s = r * (e - this.minIndex) + this.paddingLeft;
                        return this.options.gridLines.offsetGridLines && n && (s += r / 2), this.left + Math.round(s)
                    }
                    var l = this.height - (this.paddingTop + this.paddingBottom), h = l / a,
        ...
        e.exports = function (t) {
            var e = t.helpers, i = {
                ...
                determineDataLimits: function () {
                    ...
                    var i = this, n = i.options, a = n.ticks, o = i.chart, r = o.data, s = r.datasets,
                        l = i.isHorizontal();
                    ...
                    var i, n = this, a = n.options, o = a.ticks, r = e.getValueOrDefault, s = n.isHorizontal(),
                        l = n.ticks = [];
                    ...
                    var a, o, r = this, s = r.paddingLeft, l = r.paddingBottom, h = r.start, d = +r.getRightValue(t),
                        u = r.end - h;
        ...
        e.exports = function (t) {
            var e = t.helpers, i = {
                ...
                determineDataLimits: function () {
                    ...
                    var o, r, s = this, l = s.start, h = +s.getRightValue(t), d = e.log10(s.end) - e.log10(l),
                        u = s.paddingTop, c = s.paddingBottom, f = s.paddingLeft;
        ...
        e.exports = function (t) {
            var e = t.helpers, i = t.defaults.global, n = {
                ...
                getValueCount: function () {
                    ...
                    n = Math.max(2, n);
                    var a = e.niceNum(this.max - this.min, !1), o = e.niceNum(a / (n - 1), !0),
                        r = Math.floor(this.min / o) * o, s = Math.ceil(this.max / o) * o, l = Math.ceil((s - r) / o);
                    ...
                    var t, n, a, o, r, s, l, h, d, u, c, f, g = this.options.pointLabels,
                        ...
                        b = e.getValueOrDefault(g.fontFamily, i.defaultFontFamily), v = e.fontString(m, p, b),
                        y = e.min([this.height / 2 - m - 5, this.width / 2]), x = this.width, k = 0;
                    ...
                    if (this.options.display) {
                        ...
                        if (e.each(this.ticks, function (n, a) {
                            ...
                            for (var n = this.getValueCount() - 1; n >= 0; n--) {
                                ...
                                var u = this.pointLabels.length, c = this.pointLabels.length / 2, f = c / 2,
                                    g = f > n || n > u - f, m = n === f || n === u - f;
